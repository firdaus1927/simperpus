...
<main id="main" class="main">
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dataguru.php">Data Anggota Guru</a></li>
    ...
    <section class="section dashboard">
        <div class="content">
            ...
            <a href="form_anggota.php" class="btn btn-primary mb-3">Tambah Anggota Guru</a>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                  ...
                  $anggota = mysqli_query($koneksi, "SELECT * FROM anggota WHERE level = 'guru'");
                  $no=1;
