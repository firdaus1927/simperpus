...
<main id="main" class="main">
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="nonfiksi.php">Data Buku Non Fiksi</a></li>
        ...
        <div class="content">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                  ...
                  $buku = mysqli_query($koneksi, "SELECT * FROM buku WHERE genre = 'Non Fiksi'");
                  $no=1;
