...
<main id="main" class="main">
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="datapengembalian.php">Data Transaksi Peminjaman</a></li>
    ...
    <section class="section dashboard">
        <div class="content">
            ...
            <a href="form_transaksi.php" class="btn btn-primary mb-3">Tambah Transaksi Peminjaman</a>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                  ...
                  $anggota = mysqli_query($koneksi, "SELECT * FROM peminjaman WHERE status ='dipinjam'");
                  $no=1;
